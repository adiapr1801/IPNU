                        ...
                        <div class="media">
                            <div class="parrent pull-left">
                                <ul class="nav nav-tabs nav-stacked">
                                    ...
                                    <li class="active"><a href="#tab2" data-toggle="tab" class="analistic-02">Tambah Gallery</a></li>
	...
	<?php } ?>
                                    ...
                                    <div class="tab-pane fade active in" id="tab2">
                                        <div class="media">
										   ...
										   <?php
	$id=$_GET['id'];
	$q = mysqli_query($koneksi,"SELECT * FROM galeri where no='$id'");
	while($r = mysqli_fetch_array($q)){
											?>
                                       <form action="api/update_galeri.php?id=<?php echo "$id"; ?>" method="post" enctype="multipart/form-data">
									  	<table width="100%" border="0">
                                          <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><input name="keterangan" type="text" id="keterangan" 
											value="<?php echo $r['keterangan']; ?>" style="width:600px; padding-left:10px;border-radius:4px" maxlength="100" placeholder="Maksimal 100 karakter" /></td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><p>
                                              <input type="submit" value="Update Galeri" />
                                            </p>
                                              <p>&nbsp; </p></td>
                                          </tr>
                                        </table>
