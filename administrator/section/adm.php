		...
		<h1 style="color:#006600;text-align:center; font-weight:bold;">Welcome ADMISTRATOR</h1>
            <div class="row">
                <div class="col-xs-12 col-sm-8 wow fadeInDown" style="width:97%;">
                   <div class="tab-wrap" style="width:92%"> 
                        <div class="media">
                            <div class="parrent pull-left">
                                <ul class="nav nav-tabs nav-stacked">
									<li class="active"><a href="#tab0" data-toggle="tab" class="analistic-03">Dashboard</a></li>
                            ...
                            <div class="parrent media-body">
								<div class="tab-content">
                                    ...
                                    <div class="tab-pane fade focsus" id="tab1">
                                         <div class="media">
                                           <div class="media-body">
...
?>
	...
	<?php } ?>
                                    ...
                                    <div class="tab-pane fade" id="tab2" name="tab2">
                                        <div class="media">
                                           <div class="media-body">
...
include('api/koneksi.php');	
  ...
  $total = mysqli_num_rows($result);
  $pages = ceil($total/$halaman);            
  $query = mysqli_query($koneksi,"select * from berita order by no desc LIMIT $mulai, $halaman")or die(mysql_error);
  $no =$mulai+1;
?>
                                      <table width="100%" border="1">
                                        <tr>
