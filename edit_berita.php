                        ...
                        <div class="media">
                            <div class="parrent pull-left">
                                <ul class="nav nav-tabs nav-stacked">
                                    ...
                                    <li class="active"><a href="#tab3" data-toggle="tab" class="tehnical">Tambah Berita</a></li>
                                    <li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Tambah Opini</a></li>
...
?>
  <tr>
    ...
    <td><div align="center">
			<a href="api/edit_anggota.php?id=<?php echo $d['id_anggota']; ?>">
...
<?php
	$id=$_GET['id'];
	$q = mysqli_query($koneksi,"SELECT * FROM berita1 where no='$id'");
	while($r = mysqli_fetch_array($q)){
?>
                                        <form action="api/update_berita.php?id=<?php echo "$id"; ?>" method="post" enctype="multipart/form-data">
									  	<table width="100%" border="0">
                                          <tr>
                                            ...
                                            <td width="78%"><label>
                                              <input name="judul" type="text" placeholder="Masukkan judul"
											   style="width:600px; padding-left:10px;border-radius:4px" value="<?php echo $r['judul']; ?>" />
                                            </label></td>
                                          </tr>
                                          <tr>
                                            <th scope="row"><div align="right">Penulis</div></th>
                                            <td>&nbsp;</td>
                                            <td><input name="penulis" type="text" placeholder="Jika lebih dari 1, pisahkan dengan koma"
                                          ...
                                          <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><input name="kunci" type="text" placeholder="Jika lebih dari 1, pisahkan dengan koma" 
											value="<?php echo $r['katakunci']; ?>" style="width:600px; padding-left:10px;border-radius:4px" /></td>
                                          </tr>
                                          <tr>
                                            <th scope="row"><div align="right">Gambar</div></th>
                                            <td>&nbsp;</td>
                                          ...
                                          <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><textarea style="width:600px;height:500px;" name="artikel"><?php echo $r['artikel']; ?>"</textarea></td>
                                          </tr>
                                          <tr>
                                            <th scope="row"><div align="right"></div></th>
                                            <td>&nbsp;</td>
                                          ...
                                          <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td><p>
                                              <input type="submit" value="Perbaharui Berita" />
                                            </p>
                                              <p>&nbsp; </p></td>
                                          </tr>
                                        </table>
...
?>
                                        <tr>
                                          ...
                                          <td><div align="center">
										  	<a href="api/edit_berita.php?id=<?php echo $d['no']; ?>">
											<img src="img/75476-2019-02-08-edit-icon-png-small-11563142463qiwrzqx0e1.png" width="25" /></a> | 
...
?>
                                        <tr>
                                          ...
                                          <td><div align="center"><img src="img/imgberita/<?php echo $d['gambar']; ?>" width="50" /></div></td>
                                          <td><div align="center">
										  	<a href="api/edit_opini.php?id=<?php echo $d['no']; ?>">
											<img src="img/75476-2019-02-08-edit-icon-png-small-11563142463qiwrzqx0e1.png" width="25" /></a> | 
...
?>
                                        <tr>
                                          ...
                                          <td><div align="center"><img src="img/imgberita/<?php echo $d['gambar']; ?>" width="50" /></div></td>
                                          <td><div align="center">
										  	<a href="api/edit_doa.php?id=<?php echo $d['no']; ?>">
											<img src="img/75476-2019-02-08-edit-icon-png-small-11563142463qiwrzqx0e1.png" width="25" /></a> | 
...
?>
                                        <tr>
                                          ...
                                          <td><div align="center"><img src="img/imgberita/<?php echo $d['gambar']; ?>" width="50" /></div></td>
                                          <td><div align="center">
										  	<a href="api/edit_hikmah.php?id=<?php echo $d['no']; ?>">
											<img src="img/75476-2019-02-08-edit-icon-png-small-11563142463qiwrzqx0e1.png" width="25" /></a> | 
