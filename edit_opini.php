...
<div class="container">
                        ...
                        <div class="media">
                            <div class="parrent pull-left">
                                <ul class="nav nav-tabs nav-stacked">
                                    <li class="active"><a href="#tab4" data-toggle="tab" class="tehnical">Edit Opini</a></li>
                                </ul>
                            </div>
	...
	$id=$_GET['id'];
	$q = mysqli_query($koneksi,"SELECT * FROM opini where no='$id'");
	while($r = mysqli_fetch_array($q)){
											?>
                                       <form action="api/update_opini.php?id=<?php echo "$id"; ?>" method="post" enctype="multipart/form-data">
